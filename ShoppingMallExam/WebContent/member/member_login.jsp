...
<script>
	...
	function openConfirmId(loginform){
		...
		open(url,"confirm","toolbar=no, location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=550px,height=400px");
	}

</script>
</head>
<body>
	<table width="960" cellspacing=0 cellpanding=0 border=0 align=center>
		<tr>
										 	 ...
										 	 <table cellpadding="0" cellspacing="0" border=0>
											 	...
											 	<tr>
											 		<td style="padding:15 0 15 70;">
											 			<table width=400 border=0 cellpadding="0" cellspacing="0">
											 				<tr>
											 					<td width=8><img alt="img" src="#" height="7" width="8"></td>
											 				<td width=392><font size=2 color=565656>아이디가 없을경우 '회원가입'을 클릭하십시오</font>
											 				</td>
											 				</tr>
											 				<tr>
											 				<td><img src="#" width=8 height=7></td>
											 				<td> <font size=2 color=565656>아이디 또는 비밀번호를 잊어버렸을 경우 '아이디/비밀번호 찾기'를 클릭하십시오.</font>
											 				</td>
											 				</tr>
											 			</table>
											 		</td>
